<template>
	<view style="padding-bottom: 0px;" class="u-subsection" ref="u-subsection" :class="[`u-subsection--${mode}`]"
		:style="[$u.addStyle(customStyle), wrapperStyle]">
		<view style="margin-bottom: 0px;" class="u-subsection__bar" ref="u-subsection__bar" :style="[barStyle]" :class="[
		...
		<view class="u-subsection__item" :class="[
            ...
            ]" :ref="`u-subsection__item--${index}`" :style="[itemStyle(index)]" @tap="clickHandler(index)"
