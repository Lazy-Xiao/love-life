<template>
	<view class="u-scroll-list" ref="u-scroll-list">
		...
		<scroll-view class="u-scroll-list__scroll-view" scroll-x @scroll="wxs.scroll" @scrolltoupper="wxs.scrolltoupper"
			...
			<!-- #endif -->
			<view class="u-scroll-list__indicator" v-if="indicator" :style="[$u.addStyle(indicatorStyle)]">
				<view class="u-scroll-list__indicator__line bar" :style="[lineStyle]"
					style="width: 8.9vw; padding-right: 0.2vw;">
					<view class="u-scroll-list__indicator__line__bar" :style="[barStyle]  "
						ref="u-scroll-list__indicator__line__bar" style=""></view>
				</view>
			</view>
	</view>
</template>
